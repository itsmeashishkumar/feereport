...
public class AddAccountantPT extends JFrame {
	static AddAccountantPT frame;
	...
	public AddAccountantPT() {
		...
		btnAddAccountant.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				AccountantPT a=new AccountantPT(name,password,email,contactno);
				int status= AccountantDaoPT.save(a);
				
				if(status>0){
					JOptionPane.showMessageDialog(AddAccountantPT.this,"Accountant added successfully!");
					textField.setText("");textField_1.setText("");textField_2.setText("");
					passwordField.setText("");
				}else{
					JOptionPane.showMessageDialog(AddAccountantPT.this,"Sorry, Unable to add Accountant!");
				}
			}
		});
		...
		btnBack.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AdminSectionPT.main(new String[]{});
				frame.dispose();
			}
		});
