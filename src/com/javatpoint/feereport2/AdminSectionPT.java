...
public class AdminSectionPT extends JFrame {
	static AdminSectionPT frame;
	...
	public AdminSectionPT() {
		...
		btnAddAccountant.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AddAccountantPT.main(new String[]{});
				frame.dispose();
			}
		});
		...
		btnViewAccountant.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ViewAccountantPT.main(new String[]{});
			}
		});
