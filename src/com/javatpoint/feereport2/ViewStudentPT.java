...
public class ViewStudentPT extends JFrame {
	static ViewStudentPT frame;
	public ViewStudentPT() {
		//Code to view data in JTable
		List<StudentPT> list= StudentDaoPT.view();
		int size=list.size();
		
		String data[][]=new String[size][12];
		int row=0;
		for(StudentPT s:list){
