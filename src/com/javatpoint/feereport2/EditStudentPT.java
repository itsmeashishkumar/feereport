package com.javatpoint.feereport2;
...
public class EditStudentPT extends JFrame {
	static EditStudentPT frame;
	...
	public EditStudentPT() {
		...
		btnAddAccountant.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				StudentPT s=new StudentPT(rollno,name,email,course,fee,paid,due,address,city,state,country,contactno);
				int status= StudentDaoPT.update(s);
				
				if(status>0){
					JOptionPane.showMessageDialog(EditStudentPT.this,"Student updated successfully!");
					AccountantSectionPT.main(new String[]{});
					frame.dispose();
				}else{
					JOptionPane.showMessageDialog(EditStudentPT.this,"Sorry, Unable to add student!");
				}
			}
		});
		...
		btnLoadRecord.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(srollno==null||srollno.trim().equals("")){
					JOptionPane.showMessageDialog(EditStudentPT.this,"Please enter rollno first!");
				}else{
				int rollno=Integer.parseInt(srollno);
				StudentPT s= StudentDaoPT.getStudentByRollno(rollno);
