...
public class AddStudentPT extends JFrame {
	static AddStudentPT frame;
	...
	public AddStudentPT() {
		...
		btnAddAccountant.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				StudentPT s=new StudentPT(name,email,course,fee,paid,due,address,city,state,country,contactno);
				int status= StudentDaoPT.save(s);
				
				if(status>0){
					JOptionPane.showMessageDialog(AddStudentPT.this,"Student added successfully!");
					...
					JOptionPane.showMessageDialog(AddStudentPT.this,"Sorry, Unable to add student!");
				}
			}
		});
