...
public class AdminLoginPT extends JFrame {
	static AdminLoginPT frame;
	...
	public AdminLoginPT() {
		...
		btnLogin.addActionListener(new ActionListener() {
			...
			if(name.equals("admin")&&password.equals("admin123")){
				String s[]={};
				AdminSectionPT.main(s);
				frame.dispose();
			}else{
				JOptionPane.showMessageDialog(AdminLoginPT.this,"Sorry, username or password error!");
