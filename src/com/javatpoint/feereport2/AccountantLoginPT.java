...
public class AccountantLoginPT extends JFrame {
	static AccountantLoginPT frame;
	...
	public AccountantLoginPT() {
		...
		btnLogin.addActionListener(new ActionListener() {
			...
			boolean status= AccountantDaoPT.validate(name, password);
			if(status){
				AccountantSectionPT.main(new String[]{});
				frame.dispose();
			}else{
				JOptionPane.showMessageDialog(AccountantLoginPT.this,"Sorry, username or password error!","Login error!",JOptionPane.ERROR_MESSAGE);
			}
			}
		});
